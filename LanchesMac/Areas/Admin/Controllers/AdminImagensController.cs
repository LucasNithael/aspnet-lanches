    ...
    public class AdminImagensController : Controller
    {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            try {
                ...
                {
                    if (
                        formFile.FileName.Contains(".jpg")
        ...
        public IActionResult GetImagens()
        {
            ...
            var userImagesPath = Path.Combine(_hostingEnvironment.WebRootPath,
                _myConfig.NomePastaImagensProduto);

            DirectoryInfo dir = new DirectoryInfo(userImagesPath);
            FileInfo[] files = dir.GetFiles();
            model.PathImagensProduto = _myConfig.NomePastaImagensProduto;
        ...
        public IActionResult Deletefile(string fname)
        {
            string _imagemDeleta = Path.Combine(_hostingEnvironment.WebRootPath,
                _myConfig.NomePastaImagensProduto + "\\", fname);
